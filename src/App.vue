div<template>
  <div>
      ...
      <v-layout row wrap>
        <v-flex xs12 md6 lg6 class=" sm-pa-2">
          ...
          <div class="card">
            ...
            <div class="expirationDigit"><p>03/24</p></div>

            <div class="cardOwner"><p>John Doe</p></div>
        ...
        <v-flex xs12 md6 lg6 class="my-2 ">
          <div class="logoContainer">
            ...
            <div class="discover"><span class="description d">DISC</span><span  class="description o">O</span><span  class="description v">VER</span></div>
          ...
          <v-container>
            <v-layout>
              <v-flex xs12 md6 lg6>
                <p class="headers">Credit card number</p>
                <b-col sm="12">
      <b-form-input id="input-large"  class="inputs" size="lg" placeholder="4324 5433 9382 1030"></b-form-input>
    </b-col>
     <p class="headers">Expiration date</p>
                <b-col sm="12">
      <b-form-input id="input-large"  class="inputs" size="lg" placeholder="03/24"></b-form-input>
    </b-col>
              </v-flex>
              <v-flex xs12 md6 lg6>
                <p class="headers">Security code</p>
                   <b-col sm="12">
      <b-form-input id="input-large"  class="inputs" size="lg" placeholder="420"></b-form-input>
    </b-col>
     <p class="headers">Postal code</p>
                   <b-col sm="12">
      <b-form-input id="input-large"  class="inputs" size="lg" placeholder="10119"></b-form-input>
    </b-col>
              </v-flex>
            </v-layout>
            <v-container><b-form-radio name="radio-size" class="radio">Use this card for next time purchase</b-form-radio></v-container>
            <v-container>
              <b-button block variant="primary" size="lg" class="button">Add card</b-button>
            </v-container>
          </v-container>
        </v-flex>
      </v-layout>
    ...
    <v-container>
      <v-divider></v-divider>
      <span class="subTotal ad">Subtotal</span><span class="totals">₦2,497.00</span><br>
      <span class="tax ad ju">Estimated TAX</span><span class="totals ju">₦119.64</span><br>
      <span class="code ad jx">Promotional Code: </span><span class="jx cd">Z4KXLM9A</span><span class="totals jx">₦-60.00</span><br><br><br><br>
      <v-divider></v-divider>
      <div class="buttonTotal">
         <b-button block variant="primary" size="lg" class="buttons">Complete payment</b-button><div class="total">TOTAL:₦2556.64</div>
      </div>
    </v-container>
  </div>
</template>
...
.paywave {
  ...
  background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='15' height='35' viewBox='0 0 46 56'%3E%3Ctitle%3EContactlessIndicator 000%3C/title%3E%3Cpath fill='none' stroke='%23FFF' stroke-width='6' stroke-linecap='round' d='m35,3a50,50 0 0,1 0,50M24,8.5a39,39 0 0,1 0,39M13.5,13.55a28.2,28.5 0 0,1 0,28.5M3,19a18,17 0 0,1 0,18'/%3E%3C/svg%3E");
}
.expiration {
  color: white;
  margin-top: 15px;
...
.mastercard_icon {
  ...
  filter: drop-shadow(-6.4px 6.2px 8px rgba(0, 0, 0, 0.6));
  background-repeat: no-repeat;
  background-image: url("https://gist.githubusercontent.com/beckettnormington/9b6427d6f220b6f94e324c86d01cee30/raw/ad33f00e6e29e8e6662c4accb07bc3b0b90841a0/mastercard.svg");
...
.paypal{
  height:80px;
  width: 100px;
  background-image: url("https://cdn.freebiesupply.com/logos/thumbs/2x/paypal-logo.png");
  background-position: center;
  object-fit: contain;
...
export default { name: 'App', components: { }, data: () => ({ // }), };
